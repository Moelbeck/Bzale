...
namespace Web2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(AccountLoginDTO model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
        ...
        //    //if doesnt exists return true as Everything is ok
        //    //else return false meaning the email is taken
